    ...
    if (!journal) {
        return (
            <div style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
                ...
                <h2 style={{ color: '#1e3a5f', marginBottom: '0.5rem' }}>Journal Not Found</h2>
                <Link href="/journals" style={{ color: '#1e3a5f' }}>← Back to Journals</Link>
            </div>
        )
    }
        ...
        <main style={{ background: '#faf9f6', minHeight: '100vh' }}>
            ...
            <section style={{
                ...
                <div className="container">
                    <Link href="/journals" style={{ color: 'rgba(255,255,255,0.8)', fontSize: '0.875rem' }}>← All Journals</Link>
                    <div style={{ display: 'flex', alignItems: 'start', gap: '2rem', marginTop: '1rem' }}>
                        ...
                        <div>
                            ...
                            <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                                ...
                                {journal.is_paid && (
                                    <span style={{ opacity: 0.8, fontSize: '0.9rem' }}>${journal.price_per_page}/page</span>
                                )}
                            </div>
                        </div>
                    </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '2rem' }}>
                    ...
                    <div>
                        ...
                        <div className="card" style={{ padding: '2rem', marginBottom: '1.5rem' }}>
                            ...
                            <p style={{ color: '#4a4a4a', lineHeight: 1.7 }}>
                                {journal.description_en || 'A peer-reviewed academic journal focusing on cutting-edge research and scholarly discourse.'}
                            </p>
                        </div>
                        ...
                        <div className="card">
                            <div style={{ padding: '1.25rem 1.5rem', borderBottom: '1px solid #e5e5e5' }}>
                                <h2 style={{ fontSize: '1.25rem', fontWeight: 600, color: '#1e3a5f' }}>Published Issues</h2>
                            </div>
                            {issues.length > 0 ? (
                                <div>
                                    {issues.map((issue) => (
                                        <div key={issue.id} style={{ padding: '1.25rem 1.5rem', borderBottom: '1px solid #f3f4f6', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <div>
                                                <h3 style={{ fontWeight: 600, color: '#1e3a5f' }}>Volume {issue.volume}, Issue {issue.number}</h3>
                                ...
                                <div style={{ padding: '3rem', textAlign: 'center' }}>
                                    ...
                                    <p style={{ color: '#6b7280' }}>No issues published yet</p>
                                </div>
                            )}
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="card" style={{ padding: '1.5rem', marginBottom: '1.5rem' }}>
                            <h3 style={{ fontWeight: 600, color: '#1e3a5f', marginBottom: '1rem' }}>Submit Your Work</h3>
                            <p style={{ color: '#6b7280', fontSize: '0.875rem', marginBottom: '1rem' }}>
                                Share your research with our global academic community
                            </p>
                        ...
                        <div className="card" style={{ padding: '1.5rem' }}>
                            <h3 style={{ fontWeight: 600, color: '#1e3a5f', marginBottom: '1rem' }}>Journal Info</h3>
                            <dl style={{ fontSize: '0.875rem' }}>
                                {[
                                    { label: 'Slug', value: journal.slug },
                                    { label: 'Issues', value: issues.length },
                                    { label: 'Type', value: journal.is_paid ? 'Paid' : 'Free' },
                                ].map((d, i) => (
