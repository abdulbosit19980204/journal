            ...
            <section style={{
                ...
                <div className="container">
                    ...
                    <p style={{ fontSize: '1.25rem', opacity: 0.8, maxWidth: '600px', margin: '0 auto' }}>
                        Browse our collection of peer-reviewed published research
                    </p>
                </div>
            </section>
                ...
                <div className="container">
                    {articles.length > 0 ? (
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', gap: '2rem' }}>
                                        <div style={{ flex: 1 }}>
                                            ...
                                            <div style={{ color: '#6b7280', fontSize: '0.875rem' }}>
                                                By Author #{article.author} • Published {new Date(article.updated_at || article.created_at).toLocaleDateString()}
                                            </div>
                                        </div>
                        ...
                        <div style={{ textAlign: 'center', padding: '4rem' }}>
                            ...
                            <h3 style={{ fontSize: '1.5rem', fontWeight: 600, color: '#1e3a5f', marginBottom: '0.5rem' }}>No Published Articles Yet</h3>
                            <p style={{ color: '#6b7280', marginBottom: '2rem' }}>Check back soon for new research publications</p>
                            <Link href="/journals" className="btn btn-primary">Browse Journals</Link>
                        </div>
                    )}
                </div>
            </section>
